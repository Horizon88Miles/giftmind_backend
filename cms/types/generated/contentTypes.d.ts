...
export interface ApiArchiveArchive extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'lover'>;
...
export interface ApiCollectCollect extends Struct.CollectionTypeSchema {
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dimension: Schema.Attribute.Enumeration<
      ['category', 'occasion', 'recipient', 'interest', 'style', 'attributr']
    >;
...
export interface ApiThemeTheme extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    insightText: Schema.Attribute.String;
    isPrivateBoard: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    archive: Schema.Attribute.Relation<'oneToMany', 'api::archive.archive'>;
    blocked: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    collects: Schema.Attribute.Relation<'oneToMany', 'api::collect.collect'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::collect.collect': ApiCollectCollect;
